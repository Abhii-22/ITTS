                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900">Frontend & Python Basics</h3>
                            </div>
                            ...
                            <motion.div className="space-y-4" variants={staggerContainer}>
                                ...
                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">JavaScript & React</h4>
                                    <p className="text-black mb-3">Learn JavaScript ES6+, React, state management, and component-based development.</p>
                                    <div className="flex flex-wrap gap-2">
                                ...
                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Python Fundamentals</h4>
                                    <p className="text-black mb-3">Master Python programming, data structures, OOP, and advanced Python concepts.</p>
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <span className="px-3 py-1 bg-white/10 text-gray-900 rounded-full text-sm">Data Structures</span>
                                    </div>
                                </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-2xl font-bold text-gray-900">Backend & Advanced Development</h3>
                            </div>
                            
                            <motion.div className="space-y-4" variants={staggerContainer}>
                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Django & Flask</h4>
                                    <p className="text-black mb-3">Master Django framework, Flask microframework, and RESTful API development.</p>
                                    <div className="flex flex-wrap gap-2">
                                        <span className="px-3 py-1 bg-white/10 text-gray-900 rounded-full text-sm">Django</span>
                                        <span className="px-3 py-1 bg-white/10 text-gray-900 rounded-full text-sm">Flask</span>
                                        <span className="px-3 py-1 bg-white/10 text-gray-900 rounded-full text-sm">REST API</span>
                                    </div>
                                </motion.div>

                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Databases & ORM</h4>
                                    <p className="text-black mb-3">Learn SQL, NoSQL databases, Django ORM, and database design principles.</p>
                                    <div className="flex flex-wrap gap-2">
                                        ...
                                        <span className="px-3 py-1 bg-white/10 text-gray-900 rounded-full text-sm">Django ORM</span>
                                    </div>
                                </motion.div>

                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Authentication & Security</h4>
                                    <p className="text-black mb-3">Implement user authentication, JWT tokens, security best practices, and authorization.</p>
                                    <div className="flex flex-wrap gap-2">
                                ...
                                <motion.div className="bg-white/50 p-4 rounded-lg" variants={fadeInUp}>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-2">Deployment & DevOps</h4>
                                    <p className="text-black mb-3">Deploy applications to cloud platforms, Docker containerization, and CI/CD pipelines.</p>
                                    <div className="flex flex-wrap gap-2">
                        ...
                        <motion.div variants={fadeInLeft}>
                            ...
                            <motion.div className="grid grid-cols-1 sm:grid-cols-2 gap-6" variants={staggerContainer}>
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Versatile Skills</h3>
                                        <p className="text-black text-sm">Build complete applications from frontend to backend</p>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-black text-sm">Fullstack developers are among the most sought-after professionals</p>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-black text-sm">Python fullstack developers command premium salaries</p>
                                    </div>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Python Ecosystem</h3>
                                        <p className="text-black text-sm">Access to powerful frameworks and libraries</p>
                                    </div>
                                </motion.div>
                            </motion.div>
                        </motion.div>
                        ...
                        <motion.div className="bg-gray-50/50 p-8 rounded-xl border border-gray-700" variants={fadeInRight}>
                            <motion.div className="grid grid-cols-2 gap-6" variants={staggerContainer}>
                                <motion.div className="text-center" variants={scaleIn}>
                                    <div className="text-3xl font-bold text-gray-900 mb-2">$150B</div>
                                    <div className="text-sm text-black">Python Market Size</div>
                                </motion.div>
                                <motion.div className="text-center" variants={scaleIn}>
                                    <div className="text-3xl font-bold text-gray-900 mb-2">3.2M</div>
                                    <div className="text-sm text-black">Fullstack Jobs</div>
                                </motion.div>
                                <motion.div className="text-center" variants={scaleIn}>
                                    <div className="text-3xl font-bold text-gray-900 mb-2">85%</div>
                                    <div className="text-sm text-black">Python Adoption</div>
                                </motion.div>
                                <motion.div className="text-center" variants={scaleIn}>
                            ...
                            <motion.div className="space-y-6" variants={staggerContainer}>
                                ...
                                <motion.div className="bg-gray-50/50 p-6 rounded-xl border border-gray-700" variants={fadeInUp}>
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-900">SaaS Applications</h3>
                                    </div>
                                    <p className="text-black">
                        ...
                        <motion.div variants={fadeInRight}>
                            ...
                            <motion.div className="space-y-6" variants={staggerContainer}>
                                <motion.div className="flex items-start gap-4" variants={fadeInUp}>
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Master Fullstack Skills</h3>
                                        <p className="text-black">
                                ...
                                <motion.div className="flex items-start gap-4" variants={fadeInUp}>
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900 mb-2">Launch Fullstack Career</h3>
                                        <p className="text-black">
